        ...
        <tr>
          <td class="topic">
            <div>
              ...
              <div class="width_100 author_and_date"><span class="author">by {t_author}</span> <span class="date">on {t_date}</span></div>
            </div>
          </td>
          <td class="replies">{t_replies}</td>
          <td class="views">{t_views}</td>
          <td class="last_message"><span class="date">{t_last_date}</span><br/><span class="author">by {t_last_author}</span></td>
        </tr>
      {/topics}
      </tbody>
    </table>
